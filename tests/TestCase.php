...
class TestCase extends Orchestra
{
    ...
    protected function setUpDatabase(): void
    {
        $this->loadMigrationsFrom([
            __DIR__ . '/../database/migrations/create_mail_templates_table.php',
            __DIR__ . '/../database/migrations/create_mail_exceptions_table.php',
            __DIR__ . '/../database/migrations/add_from_to_mail_templates_table.php',
        ]);
